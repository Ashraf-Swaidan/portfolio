    ...
    <section className="whoami p-10 md:p-20 bg-primary max-w-screen-xl mx-auto text-center md:text-left">
      ...
      <div className="mb-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl ">
          Every line of code I write is a solution. From apps to business
          systems, my work is about making life smarter and more efficient.
        </p>
      </div>

      {/* Section 1: Early Curiosity */}
      <div className="whoami-section mb-14 flex sm:flex-row flex-col items-center space-x-12">
        <div className="md:w-1/2">
          <h3 className="text-2xl md:text-3xl font-semibold text-secondary">
            Natural Problem-Solver
          </h3>
          <p className="mt-4 text-md md:text-lg text-gray-700">
            I've always been drawn to challenges — whether it’s solving
            technical puzzles or improving business operations. Coding is my
            toolkit to craft effective solutions for real-world problems.
          </p>
        </div>
      ...
      <div className="whoami-section mb-4 lg:flex items-center space-x-4">
        ...
        <div className="lg:w-1/2 order-1 lg:order-2">
          ...
          <p className="mt-4 text-lg lg:text-lg text-gray-700">
            From building simple task management apps to designing business
            systems, each project has sharpened my skills — scaling solutions to
            solve real pain points efficiently.
          </p>
        </div>
      </div>
      ...
      <div className="whoami-section mb-12 lg:flex items-center">
        ...
        <div className="inline-flex items-center">
          ...
          <p className="mt-4 text-md md:text-lg text-gray-700">
            One of my greatest challenges was transforming manual business
      ...
      {/* Final CTA */}
      <div className="mt-12">
        <p className="text-lg md:text-xl  text-secondary leading-relaxed italic">
          Whether it's web apps or complex business systems,{" "}
          <b>I build solutions that create impact</b>.
        </p>
        <p className="text-md md:text-md  text-gray-700 leading-relaxed ">
        Scroll down to explore my
